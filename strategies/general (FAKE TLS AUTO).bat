...
set "REPEATS_TCP_HEAVY=11"
set "REPEATS_TCP_LIGHT=6"
set "REPEATS_UDP_MAIN=11"
set "REPEATS_UDP_LIGHT=6"
set "REPEATS_UDP_WIDE=10"
if "%AGGRESSIVE_MODE%"=="1" (
    set "REPEATS_TCP_HEAVY=12"
    set "REPEATS_TCP_LIGHT=7"
    set "REPEATS_UDP_MAIN=12"
    set "REPEATS_UDP_LIGHT=8"
    set "REPEATS_UDP_WIDE=12"
)
...
start "D-Gen: %~n0" /b "%BIN%DGen.exe" --profile general_fake_tls_auto
