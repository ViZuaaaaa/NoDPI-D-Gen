# D-Gen NODPI — автоматически настраивает подключение к недоступным сервисам (Discord • YouTube • Telegram)

> [!WARNING]
> Проект подходит не под любую сеть и не под любой тип подключения. Проект в стадии  редких доработок
...
> Вопросы тут: https://t.me/Vi_Zuaaa
...
- приоритет на практичные кейсы: YouTube, Discord, Telegram
...
### Основной сценарий
1) Нажми **Start**.
2) Открой Discord Desktop / Telegram / YouTube для проверки.
